...
\begin{center}
    \bfseries \zihao{-2}
    \begin{tabularx}{.83\textwidth}{@{\extracolsep{\fill}} >{\fangsong}l @{\extracolsep{\fill}} X<{\centering}}
        ...
        {
            % TitleEngLines == 2
            英文论文题目：&  \zihao{3} \uline{Research and Application on} \\
            ~            & \zihao{3} \uline{Arbitary Style Transfer Techniques} \\
        }
    \end{tabularx}
\end{center}
