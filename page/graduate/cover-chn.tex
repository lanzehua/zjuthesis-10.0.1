...
\begin{center}
    \bfseries \zihao{-2}
    \begin{tabularx}{\textwidth}{@{\extracolsep{\fill}} >{\fangsong}l @{\extracolsep{\fill}} X<{\centering}}
        ...
        {
            % TitleEngLines == 2
            英文论文题目：&  \zihao{3} \uline{Research on High-quality Style Transfer} \\
            ~            & \zihao{3} \uline{Techniques Based on Deep Learning} \\
        }
    \end{tabularx}
\end{center}
