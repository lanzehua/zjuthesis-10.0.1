...
\documentclass[
    ...
    % Title
    Title           = 任意风格迁移技术研究与应用,
    TitleEng        = {{Research and Application on Arbitrary Style Transfer Techniques}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{任意风格迁移技术}{研究与应用}
\titleengtwolines{Research and Application on }{Arbitrary Style Transfer Techniques}
